...
- [x] Mention two parts of Express that you learned about this week.
    Express is like React, but for the backend and can be used to route! Express can't really do much on it's own, but with middleware can be a pretty monstrous beast.
- [x] Describe Middleware?
    An array of functions that get executed in the order they're introduced into the server side.
- [x] Describe a Resource?
    According to REST, everything is a resource. REST architecture treats every content as a resource. These resources can be text files, html pages, images, videos or dynamic business data.
- [x] What can the API return to help clients know if a request was successful?
    The API can return HTTP status codes 200-299
